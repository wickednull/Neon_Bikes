...
# -- Service management -------------------------------------------------------
cleanup() {
    # Restart web services we stopped.
    # Do NOT restart pineapplepager here -- the Pager's watchdog handles that
    # automatically. Explicitly restarting it causes the "initializing system"
    # splash on every clean exit.
